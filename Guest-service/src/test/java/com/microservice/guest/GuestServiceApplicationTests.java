...
class GuestServiceApplicationTests {
	...
	public void addGuestTest() {
		Guest guest=new Guest(8083100001l,"Pranjali",1122334455,"pranjali@gmail.com","Male","Dombivli");
	...
	public void getAllGuestTest() {
		when(guestRepository.findAll()).thenReturn(Stream
				.of(new Guest(8083100001l,"Pranjali",1122334455,"pranjali@gmail.com","Female","Dombivli"),
	...
	public void updateGuestTest() {
		...
		Guest guest=new Guest(8083100001l,"Pranjali",1122334455,"pranjali@gmail.com","Female","Dombivli");
