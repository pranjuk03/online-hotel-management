...
export default function AddRoom() {
    ...
    return (
        ...
        <Header></Header>
            ...
            <TextField variant="outlined" style={{width:600}} label="Room ID" placeholder='Enter a Room Id' className={classes.id}
                value={roomId} onChange={(e)=>setRoomId(e.target.value)}>
            </TextField>
            <br></br><br></br>
            <TextField variant="outlined" style={{width:600}} label="Room Type" placeholder='Enter the type of room'
                className={classes.type} value={roomType} onChange={(e)=>setRoomType(e.target.value)}>
            </TextField>
            <br></br><br></br>
            <TextField variant="outlined" style={{width:600}}  label="Room Rent" placeholder='Enter the rent of room'
                className={classes.rent} value={roomRent} onChange={(e)=>setRoomRent(e.target.value)}>
            </TextField>
            <br></br><br></br>
            <TextField variant="outlined" style={{width:600}}  label="Room Available" placeholder='Enter the availability of room (true/false)'
